...
<div id="sidebar2" <?php graphene_grid( 'sidebar sidebar-left widget-area', 0, $graphene_settings['column_width']['two_col']['sidebar'], $graphene_settings['column_width']['three_col']['sidebar_left'] ); ?>>
